...
type EventCoinsMinted struct {
	...
	// Fee charged to the community pool for minting coins
	FeeCharged []types.Coin `protobuf:"bytes,3,rep,name=fee_charged,json=feeCharged,proto3" json:"fee_charged"`
}
...
func (m *EventCoinsMinted) GetFeeCharged() []types.Coin {
	if m != nil {
		return m.FeeCharged
	}
	return nil
...
var fileDescriptor_1c6633a1ea762f13 = []byte{
	...
	,
}
...
func (m *EventCoinsMinted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FeeCharged) > 0 {
		for iNdEx := len(m.FeeCharged) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.FeeCharged[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *EventCoinsMinted) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.FeeCharged = append(m.FeeCharged, types.Coin{})
			if err := m.FeeCharged[len(m.FeeCharged)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
