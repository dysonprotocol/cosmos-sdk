...
def test_query_classes_by_name_with_prefix(chainnet, generate_account, faucet, register_name):
    dysond_bin = chainnet[0]
    ...
    out_pref = dysond_bin("query", "nameservice", "nftclasses-by-name", "--name", root, "--subclass-prefix", "/foo")
