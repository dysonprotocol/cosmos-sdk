...
def test_web_request_with_script_address_only(chainnet, generate_account, faucet, script_code):
    ...
    web_result = dysond_bin(
        ...
        "--httprequest", web_request["httprequest"]
    )
...
def test_web_request_with_script_name_only(chainnet, generate_account, faucet, script_code):
...
def test_web_request_with_both_fields_matching(chainnet, generate_account, faucet, script_code):
...
def test_web_request_with_neither_field_fails(chainnet):
    ...
    assert isinstance(web_result, str), "Web query should fail when neither field is provided"
    assert "either script_address or script_name must be provided" in web_result, "Should indicate missing fields"
