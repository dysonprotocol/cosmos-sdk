...
var _ protoreflect.List = (*_EventCoinsMinted_3_list)(nil)

type _EventCoinsMinted_3_list struct {
	list *[]*v1beta1.Coin
}

func (x *_EventCoinsMinted_3_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_EventCoinsMinted_3_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_EventCoinsMinted_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_EventCoinsMinted_3_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_EventCoinsMinted_3_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventCoinsMinted_3_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_EventCoinsMinted_3_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_EventCoinsMinted_3_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_EventCoinsMinted_fee_charged protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EventCoinsMinted_fee_charged = md_EventCoinsMinted.Fields().ByName("fee_charged")
}
...
func (x *fastReflection_EventCoinsMinted) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.FeeCharged) != 0 {
		value := protoreflect.ValueOfList(&_EventCoinsMinted_3_list{list: &x.FeeCharged})
		if !f(fd_EventCoinsMinted_fee_charged, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventCoinsMinted) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "dysonprotocol.nameservice.v1.EventCoinsMinted.fee_charged":
		return len(x.FeeCharged) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventCoinsMinted) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dysonprotocol.nameservice.v1.EventCoinsMinted.fee_charged":
		if len(x.FeeCharged) == 0 {
			return protoreflect.ValueOfList(&_EventCoinsMinted_3_list{})
		}
		listValue := &_EventCoinsMinted_3_list{list: &x.FeeCharged}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dysonprotocol.nameservice.v1.EventCoinsMinted"))
...
func (x *fastReflection_EventCoinsMinted) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "dysonprotocol.nameservice.v1.EventCoinsMinted.fee_charged":
		lv := value.List()
		clv := lv.(*_EventCoinsMinted_3_list)
		x.FeeCharged = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dysonprotocol.nameservice.v1.EventCoinsMinted"))
		}
...
func (x *fastReflection_EventCoinsMinted) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dysonprotocol.nameservice.v1.EventCoinsMinted.fee_charged":
		if x.FeeCharged == nil {
			x.FeeCharged = []*v1beta1.Coin{}
		}
		value := &_EventCoinsMinted_3_list{list: &x.FeeCharged}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dysonprotocol.nameservice.v1.EventCoinsMinted"))
...
func (x *fastReflection_EventCoinsMinted) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dysonprotocol.nameservice.v1.EventCoinsMinted.fee_charged":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_EventCoinsMinted_3_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dysonprotocol.nameservice.v1.EventCoinsMinted"))
		}
...
func (x *fastReflection_EventCoinsMinted) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.FeeCharged) > 0 {
			for iNdEx := len(x.FeeCharged) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.FeeCharged[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				...
				x.FeeCharged = append(x.FeeCharged, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.FeeCharged[len(x.FeeCharged)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type EventCoinsMinted struct {
	...
	FeeCharged []*v1beta1.Coin `protobuf:"bytes,3,rep,name=fee_charged,json=feeCharged,proto3" json:"fee_charged,omitempty"`
}
...
func (x *EventCoinsMinted) GetFeeCharged() []*v1beta1.Coin {
	if x != nil {
		return x.FeeCharged
	}
	return nil
...
var file_dysonprotocol_nameservice_v1_events_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x64, 0x22, 0x97,
	0x01, 0x0a, 0x10, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x4d, 0x69, 0x6e,
	0x74, 0x65, 0x64, 0x12, 0x3c, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20,
	...
	0x74, 0x12, 0x45, 0x0a, 0x0b, 0x66, 0x65, 0x65, 0x5f, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65, 0x64,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e,
	0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69,
	0x6e, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x0a, 0x66, 0x65,
	0x65, 0x43, 0x68, 0x61, 0x72, 0x67, 0x65, 0x64, 0x22, 0x50, 0x0a, 0x10, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x42, 0x75, 0x72, 0x6e, 0x65, 0x64, 0x12, 0x3c, 0x0a, 0x06,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x66, 0x74, 0x49, 0x64, 0x22, 0x42, 0x0a, 0x0e,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x4e, 0x46, 0x54, 0x42, 0x75, 0x72, 0x6e, 0x65, 0x64, 0x12, 0x19,
	...
	0x22, 0x27, 0x0a, 0x0f, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x4d, 0x6f,
	0x76, 0x65, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x0d, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x4e, 0x66, 0x74, 0x4d, 0x6f, 0x76, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x63,
	0x6c, 0x61, 0x73, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63,
	0x6c, 0x61, 0x73, 0x73, 0x49, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x6e, 0x66, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x66, 0x74, 0x49, 0x64, 0x12, 0x21, 0x0a,
...
var file_dysonprotocol_nameservice_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_dysonprotocol_nameservice_v1_events_proto_goTypes = []interface{}{
	...
	(*EventCoinsMoved)(nil),                  // 23: dysonprotocol.nameservice.v1.EventCoinsMoved
	(*EventNftMoved)(nil),                    // 24: dysonprotocol.nameservice.v1.EventNftMoved
	(*v1beta1.Coin)(nil),                     // 25: cosmos.base.v1beta1.Coin
	(*timestamppb.Timestamp)(nil),            // 26: google.protobuf.Timestamp
	(*Params)(nil),                           // 27: dysonprotocol.nameservice.v1.Params
}
var file_dysonprotocol_nameservice_v1_events_proto_depIdxs = []int32{
	25, // 0: dysonprotocol.nameservice.v1.EventNameRegistered.fee:type_name -> cosmos.base.v1beta1.Coin
	26, // 1: dysonprotocol.nameservice.v1.EventNameRenewed.new_expiry:type_name -> google.protobuf.Timestamp
	25, // 2: dysonprotocol.nameservice.v1.EventNameValuationUpdated.new_valuation:type_name -> cosmos.base.v1beta1.Coin
	25, // 3: dysonprotocol.nameservice.v1.EventBidPlaced.bid_amount:type_name -> cosmos.base.v1beta1.Coin
	25, // 4: dysonprotocol.nameservice.v1.EventBidRejected.rejection_fee:type_name -> cosmos.base.v1beta1.Coin
	27, // 5: dysonprotocol.nameservice.v1.EventParamsUpdated.params:type_name -> dysonprotocol.nameservice.v1.Params
	25, // 6: dysonprotocol.nameservice.v1.EventCoinsMinted.amount:type_name -> cosmos.base.v1beta1.Coin
	25, // 7: dysonprotocol.nameservice.v1.EventCoinsMinted.fee_charged:type_name -> cosmos.base.v1beta1.Coin
	25, // 8: dysonprotocol.nameservice.v1.EventCoinsBurned.amount:type_name -> cosmos.base.v1beta1.Coin
