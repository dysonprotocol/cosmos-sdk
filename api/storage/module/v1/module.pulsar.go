...
func (x *Module) slowProtoReflect() protoreflect.Message {
	mi := &file_dysonprotocol_storage_module_v1_module_proto_msgTypes[0]
...
func (x *fastReflection_Module) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message dysonprotocol.storage.module.v1.Module does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Module) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message dysonprotocol.storage.module.v1.Module does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Module) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in dysonprotocol.storage.module.v1.Module", d.FullName()))
	}
	panic("unreachable")
}
...
var file_dysonprotocol_storage_module_v1_module_proto_rawDesc = []byte{
	0x0a, 0x2c, 0x64, 0x79, 0x73, 0x6f, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f,
	0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2f, 0x76,
...
var (
	file_dysonprotocol_storage_module_v1_module_proto_rawDescOnce sync.Once
	file_dysonprotocol_storage_module_v1_module_proto_rawDescData = file_dysonprotocol_storage_module_v1_module_proto_rawDesc
)

func file_dysonprotocol_storage_module_v1_module_proto_rawDescGZIP() []byte {
	file_dysonprotocol_storage_module_v1_module_proto_rawDescOnce.Do(func() {
		file_dysonprotocol_storage_module_v1_module_proto_rawDescData = protoimpl.X.CompressGZIP(file_dysonprotocol_storage_module_v1_module_proto_rawDescData)
	})
	return file_dysonprotocol_storage_module_v1_module_proto_rawDescData
}
...
func file_dysonprotocol_storage_module_v1_module_proto_init() {
	if File_dysonprotocol_storage_module_v1_module_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_dysonprotocol_storage_module_v1_module_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Module); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dysonprotocol_storage_module_v1_module_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dysonprotocol_storage_module_v1_module_proto_goTypes,
		DependencyIndexes: file_dysonprotocol_storage_module_v1_module_proto_depIdxs,
		MessageInfos:      file_dysonprotocol_storage_module_v1_module_proto_msgTypes,
	}.Build()
	File_dysonprotocol_storage_module_v1_module_proto = out.File
	file_dysonprotocol_storage_module_v1_module_proto_rawDesc = nil
	file_dysonprotocol_storage_module_v1_module_proto_goTypes = nil
	file_dysonprotocol_storage_module_v1_module_proto_depIdxs = nil
}
